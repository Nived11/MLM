...
import { PaymentsApproved, PendingPayments } from "../../features/admin-payment";
...
const Payment = () => {
  ...
  return (
    <div className="bg-background px-4 py-4 text-white mb-20 mt-0 lg:mt-18">
      ...
      <div className="flex items-center w-full rounded-2xl bg-[#0E0B1A] px-4 py-2 shadow-sm border border-[#1c1a29] mb-4
