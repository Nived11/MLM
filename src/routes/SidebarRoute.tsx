...
import UserProtectedRoute from "../components/route-protection/UserProtectedRoute";

const SidebarRoute = (user: boolean) => {
  return (
    <Route element={<UserProtectedRoute isUser={user} />}>
