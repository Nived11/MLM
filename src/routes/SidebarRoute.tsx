...
const SidebarRoute = () => {
  return (
    <Route element={<SidebarLayout />}>
      ...
      <Route path="/send-help/payment" element={<SendHelpPay />} /> {/* Abhitha */}
      <Route path="/wallet" element={<Wallet />} /> {/* Abhitha */}

      <Route path="/rebirth-users">{/* Abhitha */}
