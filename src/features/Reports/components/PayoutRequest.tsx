...
import { usepayoutRequest } from "../hooks/payoutReport";
import SkeletonTable from "./SkeletonTable";
import { SlidersHorizontal } from "lucide-react";

const PayoutRequest = () => {
  const { users, isLoading, error } = usepayoutRequest();
                    ...
                    {isLoading ? (
                      ...
                      users.map((user, idx) => (
                        ...
                        >
                          ...
                          <td className="px-2 py-3">{user.payoutamount}</td>
