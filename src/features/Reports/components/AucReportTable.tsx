import { useaucRequest } from "../hooks/aucReport";
import SkeletonTable from "./SkeletonTable";

const AucReportTable = () => {
  const { users, isLoading, error } = useaucRequest();
          ...
          {isLoading ? (
            ...
            users.map((user, idx) => (
              ...
              >
                ...
                <td className="px-2 py-3 whitespace-nowrap">{user.date}</td>
              </tr>
            ))
          )}
          <tr>
