...
const reportRebirthusers = () => {
  const { users, isLoading, error } = useRebirthReportusers();
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="p-[1px] rounded-md bg-gradient-to-r from-[var(--purple-1)] to-[var(--purple-2)] max-w-xs lg:max-w-55">
                      ...
                      >
                        ...
                        <option>LX00133</option>
                        <option>LX00134</option>
                        <option>LX00135</option>
                        <option>LX00136</option>
                      </select>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="p-[1px] rounded-md bg-gradient-to-r from-[var(--purple-1)] to-[var(--purple-2)] max-w-xs lg:max-w-55">
                      ...
                      >
                        <option>Select Name/Email/Mobile</option>
                        <option>ARJUN</option>
                        <option>ADIL</option>
