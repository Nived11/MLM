...
export default function EditProfile({ user, mode, onClose }: EditProfileProps) {
  ...
  const {
    ...
    handleFileChange,
    handleSave,
  } = useEditProfile({ initialUser: user, onClose });
        ...
        <div className="bg-black rounded-lg px-4 py-6 flex flex-col md:flex-row gap-6 md:gap-10">
          <div className="flex flex-col items-center md:w-1/3 relative">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-gray-400">{formData.level}</p>
            </div>
          </div>
