...
const ReferralLink: React.FC = () => {
    ...
    return (
        <div className="rounded-2xl rounded-br-2xl p-[1px] bg-gradient-to-l from-purple-1 to-purple-2 md:h-[320px] lg:h-[352px] xl:h-[376px] 2xl:h-[345px] ">
            <div className="bg-black rounded-2xl rounded-br-2xl p-4 sm:p-8">
                ...
                <div className="flex flex-row gap-3 sm:gap-4 mb-4 sm:mb-6 sm:w-full">
                    <button
                        className="border-2 border-purple-700 text-white font-normal text-sm sm:text-lg xl:text-2xl 
                    ...
                    <button
                        ...
                        className="bg-purple-900 hover:bg-purple-700 text-white font-normal text-sm sm:text-lg xl:text-2xl  rounded-lg px-4 sm:px-8 py-2 transition-colors w-full sm:w-1/2"
                    >
                ...
                <div className="mb-4 sm:mb-6">
                    <div className="rounded-lg border border-purple-700 px-2 sm:px-4 py-3 sm:py-3">
                        <span className="block w-full text-xs sm:text-base lg:text-xl  xl:text-2xl  text-white select-all 
                ...
                <div>
                    <div className="bg-purple-900 rounded-lg  px-2 sm:px-3 lg:px-3 py-2 sm:py-3 lg:py-3">
                        <span className="block text-xs sm:text-sm lg:text-base xl:text-2xl  text-white ">
